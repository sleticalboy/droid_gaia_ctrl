...
package cn.qualcomm.lib.vmupgrade;
...
import cn.qualcomm.lib.vmupgrade.codes.OpCodes;
import cn.qualcomm.lib.vmupgrade.codes.ResumePoints;
import cn.qualcomm.lib.vmupgrade.codes.ReturnCodes;
import cn.qualcomm.lib.vmupgrade.packet.VMUException;
import cn.qualcomm.lib.vmupgrade.packet.VMUPacket;
...
public class UpgradeManager {
     ...
     * {@link cn.qualcomm.lib.vmupgrade.codes.OpCodes.Enum#UPGRADE_DATA_BYTES_REQ UPGRADE_DATA_BYTES_REQ} request.
     */
     ...
     * {@link cn.qualcomm.lib.vmupgrade.codes.OpCodes.Enum#UPGRADE_SYNC_REQ UPGRADE_SYNC_REQ} to start the
     * process.</p>
     * <p>This method can dispatch a VMUError object if the manager has not been able to start the upgrade process.</p>
     * <p>The possible {@link UpgradeError.ErrorTypes ErrorTypes} are the following:
     * <ul>
     ...
     * {@link cn.qualcomm.lib.vmupgrade.codes.OpCodes.Enum#UPGRADE_DATA_BYTES_REQ} request.
     */
    ...
    public @interface ConfirmationType {
         ...
         * {@link cn.qualcomm.lib.vmupgrade.codes.ReturnCodes.Enum#WARN_SYNC_ID_IS_DIFFERENT WARN_SYNC_ID_IS_DIFFERENT},
         * the listener has to ask if the upgrade should continue or not.</p>
         */
        int WARNING_FILE_IS_DIFFERENT = 4;
        /**
         * <p>>When the Host receives
         * {@link cn.qualcomm.lib.vmupgrade.codes.ReturnCodes.Enum#ERROR_BATTERY_LOW ERROR_BATTERY_LOW},the
