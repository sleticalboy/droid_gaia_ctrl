...
package cn.qualcomm.lib.vmupgrade.codes;

import android.annotation.SuppressLint;
import androidx.annotation.IntDef;

import cn.qualcomm.lib.vmupgrade.VMUUtils;
...
public final class OpCodes {
    ...
    public class UpgradeErrorWarnRES {
        /**
         * The offset from where the error code information as a {@link cn.qualcomm.lib.vmupgrade.codes.ReturnCodes.Enum
         * ReturnCodes} starts.
         */
