...
package cn.qualcomm.gaia.rwcp;

import android.os.Handler;
import android.util.Log;

import cn.qualcomm.gaia.Utils;
 ...
 * get a {@link Segment Segment}. Then depending on the {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode opration code}
 * and the current {@link cn.qualcomm.gaia.rwcp.RWCP.State state} it handles the received segment.</p>
...
public class RWCPClient {
     ...
     * {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#SYN_ACK SYN_ACK} segment.</p>
     * <p>A SYN_ACK segment can be expected on the following cases:
     * <ul>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#SYN_SENT SYN_SENT}: default behaviour, the
     *     Client can start the data transfer.</li>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#ESTABLISHED ESTABLISHED}: the Server has not
     ...
     *          {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#SYN_ACK SYN_ACK}.
     *
    ...
    /**
     * <p>This method is called by {@link #onReceiveRWCPSegment(byte[]) onReceiveRWCPSegment} when it has received a
     * {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#DATA_ACK DATA_ACK} segment.</p>
     * <p>A DATA_ACK segment can be expected on the following cases:
     * <ul>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#ESTABLISHED ESTABLISHED}: the Server acknowledges
     *     the data it has received. This client then validates the acknowledged data and send more if it has free
     *     credits.</li>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#CLOSING CLOSING}: when this client has sent a
     *     {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Client#RST RST} segment but it has not been fetched yet by the
     *     Server.</li>
     * </ul></p>
     *
     * @param segment
     *          The received segment with the operation code
     *          {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#DATA_ACK DATA_ACK}.
     *
     * @return True if the segment has successfully been handled.
     */
    ...
    /**
     * <p>This method is called by {@link #onReceiveRWCPSegment(byte[]) onReceiveRWCPSegment} when it has received a
     * {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST RST} or a
     * {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST_ACK RST_ACK} segment.</p>
     * <p>A RST segment can be expected on the following cases:
     * <ul>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#ESTABLISHED ESTABLISHED}: the Server requests a
     *     reset of the session, this cancels the transfer.</li>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#CLOSING CLOSING}: This might be a
     *     {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST_ACK RST_ACK} - the
     *     Server acknowledges a RST sent by this client. The session is ended.</li>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#SYN_SENT SYN_SENT}: This might be a
     *     {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST_ACK RST_ACK} - the
     ...
     * @param segment
     *          The received segment with the operation code
     *          {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST RST} or
     *          {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#RST_ACK RST_ACK}.
     *
     * @return True if the segment has successfully been handled.
     */
    ...
    /**
     * <p>This method is called by {@link #onReceiveRWCPSegment(byte[]) onReceiveRWCPSegment} when it has received a
     * {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#GAP GAP} segment.</p>
     * <p>A DATA_ACK segment can be expected on the following cases:
     * <ul>
     *     <li>state {@link cn.qualcomm.gaia.rwcp.RWCP.State#ESTABLISHED ESTABLISHED}: the Server acknowledges
     ...
     * @param segment
     *          The received segment with the operation code
     *          {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Server#GAP GAP}.
     *
     * @return True if the segment has successfully been handled.
     */
    ...
    public interface RWCPListener {
         ...
         *     <li>The Server sent a {@link cn.qualcomm.gaia.rwcp.RWCP.OpCode.Client#RST RST} segment.</li>
         * </ul></p>
         */
