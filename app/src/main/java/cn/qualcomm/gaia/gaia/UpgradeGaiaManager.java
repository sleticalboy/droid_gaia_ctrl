...
import cn.qualcomm.gaia.rwcp.RWCP;
...
import cn.qualcomm.lib.gaia.packets.GaiaPacketBREDR;
...
public class UpgradeGaiaManager extends AGaiaManager implements UpgradeManager.UpgradeManagerListener {
     ...
     *              {@link cn.qualcomm.lib.vmupgrade.packet.VMUPacket VMUPacket}.
     */
    ...
    public interface GaiaManagerListener {
         ...
         * {@link cn.qualcomm.lib.vmupgrade.codes.ResumePoints.Enum#DATA_TRANSFER DATA_TRANSFER}.</p>
         *
         * @param percentage
