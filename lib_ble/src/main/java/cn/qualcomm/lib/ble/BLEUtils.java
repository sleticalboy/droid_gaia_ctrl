...
public class BLEUtils {
     ...
     * {@link cn.qualcomm.lib.ble.BLEService.State#CONNECTED CONNECTED},
     * {@link cn.qualcomm.lib.ble.BLEService.State#CONNECTING CONNECTING},
     * {@link cn.qualcomm.lib.ble.BLEService.State#DISCONNECTING DISCONNECTING} and
     * {@link cn.qualcomm.lib.ble.BLEService.State#DISCONNECTED DISCONNECTED}, this
     * method returns "UNKNOWN" as the label.</p>
     *
     * @param state
     *          The state to get a corresponding label for.
     ...
     * These status can be:
     * <ul>
     *     <li>{@link cn.qualcomm.lib.ble.ErrorStatus.HCI HCI} or
     *     {@link cn.qualcomm.lib.ble.ErrorStatus.ATT ATT} layers related.</li>
     *     <li>Android {@link cn.qualcomm.lib.ble.ErrorStatus.GattApi GattApi} implementation related as
     ...
     * <ul>
     *     <li>{@link cn.qualcomm.lib.ble.ErrorStatus.HCI#getLabel(int, boolean) HCI.getLabel()} and
     *     {@link cn.qualcomm.lib.ble.ErrorStatus.ATT#getLabel(int, boolean) ATT.getLabel()}</li>
     *     <li>{@link cn.qualcomm.lib.ble.ErrorStatus.GattApi#getLabel(int, boolean) GattApi.getLabel()}</li>
     *     <li>{@link cn.qualcomm.lib.ble.ErrorStatus#getBluetoothGattStatusLabel(int, boolean)
