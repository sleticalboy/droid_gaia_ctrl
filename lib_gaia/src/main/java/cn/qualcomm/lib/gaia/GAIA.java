...
public final class GAIA {
     ...
     * {@link cn.qualcomm.lib.gaia.GAIA.Status#NOT_STATUS} if neither {@link GAIA.Status} fits the value.
     */
     ...
     * {@link cn.qualcomm.lib.gaia.GAIA.NotificationEvents#NOT_NOTIFICATION} if neither
