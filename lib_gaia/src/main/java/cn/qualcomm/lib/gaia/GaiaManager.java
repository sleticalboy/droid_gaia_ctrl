...
import cn.qualcomm.lib.gaia.requests.GaiaAcknowledgementRequest;
import cn.qualcomm.lib.gaia.requests.GaiaRequest;
 ...
 * {@link cn.qualcomm.lib.gaia.GAIA.Transport#BLE BLE} and
 * {@link cn.qualcomm.lib.gaia.GAIA.Transport#BR_EDR BR_EDR}. Depending on the transport the structure of a GAIA
...
public abstract class GaiaManager {
     ...
     * {@link cn.qualcomm.lib.gaia.GAIA.Status#NOT_SUPPORTED NOT_SUPPORTED}.</p>
     */
